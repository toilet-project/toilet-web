...
const record={schema:1,target:manifest.target,workerName:manifest.target==='preview'?'geupddong-web-preview':'geupddong-web-production',
  workerVersion,cacheNamespace:manifest.appVersion,appVersion:manifest.appVersion,buildId:manifest.buildId,
  sourceCommit:manifest.sourceCommit,deployedAt:new Date(deployedAt).toISOString()}
