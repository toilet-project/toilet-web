...
test('scheduled cleanup is fail-closed, capped and shares the manual cleanup lock',()=>{
  ...
  assert.match(cleanup,/cache-cleanup-plan\.json/);assert.match(cleanup,/--expected-delete-fingerprint/)
