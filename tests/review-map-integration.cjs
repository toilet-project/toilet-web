...
;(async () => {
  ...
  try {
    for (const width of [390, 320, 1280]) {
      ...
      await context.close()
      console.log(`PASS actual map ${width}; form visible ${openMs}ms; shared/aligned stars; transparent tap highlight; direct wait/default 0/edit; one-line distance; refresh pulse/reduced motion; create/edit/detach; no business writes`)
    }
