...
;(async () => {
  ...
  try {
    for (const width of [390, 320, 1280]) {
      ...
      await context.close()
      console.log(`PASS actual map ${width}; precheck visible ${openMs}ms; inputs only after auth+GPS; blue/red paper; later retry retains draft; create/edit/detach; no business writes`)
    }
