...
브라우저 검사: 생성/수정/작성자 연결 해제/본문 잔존/7일 경계/150m 실패/저장 실패 입력 보존/로그인 안내/새로고침 초기화, 폭 320·390·1280의 가로 넘침, HTTP 쓰기 요청 없음. Chromium 모바일 에뮬레이션이며 실제 iPhone Safari/Chrome 인수와는 다르다.
