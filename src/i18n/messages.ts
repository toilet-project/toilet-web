...
const ko = {
  ...
  'map.outsideKorea': '현재 위치가 한국 밖이에요. 서울역을 기준으로 지도를 보여드릴게요.',
  'map.checking': '확인 중',
  ...
  'detail.simplifiedFallback': '일부 정보는 중국어 간체로 표시',
  'detail.englishFallback': '일부 정보는 영어로 표시',
...
const en = {
  ...
  'map.outsideKorea': 'Your location is outside Korea. Showing the map from Seoul Station.',
  ...
  'detail.simplifiedFallback': 'Some details are shown in Simplified Chinese',
  'detail.englishFallback': 'Some details are shown in English',
