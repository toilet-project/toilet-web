...
const apiErrors: Record<string, string> = {
  ...
  REVIEW_ALREADY_EXISTS: 'You can review each toilet once every 24 hours. Check your existing review.',
  ...
  INVALID_TARGET: 'Real reviews cannot be saved for test toilets.',
...
const locationErrors: Record<string, string> = {
  '이 화장실의 위치를 확인할 수 없어 리뷰를 작성할 수 없어요.': 'This toilet’s location is unavailable, so reviews cannot be posted.',
  ...
  '작성 후 24시간이 지나야 다시 리뷰를 남길 수 있어요.': 'You can review each toilet once every 24 hours.',
