  ...
  if (kind === 'privacy') return <PolicyLayout title="개인정보 처리방침" embedded={embedded}>
    ...
    <section id="erasure-records"><h2>4-1. 백업과 계정 재생 방지 기록</h2>
      ...
      <dl className="policy-storage-facts">
        ...
        <div><dt>종료 기준 검토</dt><dd>관련 과거 사본의 소멸과 독립 검증 기준의 갱신을 확인한 뒤 기록을 정리하는 절차를 검토 중입니다. 복구 동의 기간인 3개월이나 임의의 일수가 이 대장의 자동 삭제일은 아닙니다.</dd></div>
      </dl>
      ...
      <p className="policy-draft-notice">공개 전 확인: 기존 외부 저장소의 잔여 사본, 독립 검증 정보와 외부 서비스의 처리 범위, 기존 이용자 고지, 회원 개인정보가 남은 사본과 계정 재생 방지 기록의 보관 종료 절차. 아래 문의처로 삭제·처리정지를 요청할 수 있습니다.</p>
    </section>
